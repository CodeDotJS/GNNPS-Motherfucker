            	...
            	case 1:
            		{
	                    ...
	                    cout<<"\t 2.Dr Maanvi Singhal \n";
	                    cout<<"\t 3.Dr Anamitra Malhotra \n";
							 ...
							 case 3:
							 	{
	                                    ...
	                                    cout<<"\t 1.Dr Shruti Pandey \n";
	                                    cout<<"\t 2.Dr Vandana Pandey \n";
	                                    cout<<"\t 3.Dr Yashi Tripathi \n";
	                                    cout<<"\n Please enter your choice:";
	                                    cin>>phy_ch;
                                       	switch (phy_ch)
                                       	{
								...
								case 4:
									{
	                                    ...
	                                    cout<<"\t 1.Dr Manoj Bhandari \n";
	                                    cout<<"\t 2.Dr Sanjay Kapoor \n";
	                                    cout<<"\t 3.Dr Ahmed Ansari \n";
	                                    cout<<"\n Please enter your choice:";
	                                    cin>>dental_ch;
	                                    switch (dental_ch)
	                                    {
									...
									case 5:
										{
	                                        ...
	                                        cout<<"\t 1.Dr Akhilesh Yadav \n";
	                                        cout<<"\t 2.Dr Ayush Agrahari \n";
	                                        cout<<"\t 3.Dr Anshuman Barnwal \n";
	                                        cout<<"\n Please enter your choice:";
	                                        cin>>gas_ch;
	                                        switch (gas_ch)
	                                        {
										 ...
										 case 6:
										 	{
	                                            ...
	                                            cout<<"\t 1.Dr Shreya Jaiswal \n";
	                                            cout<<"\t 2.Dr Dinesh Barnwal \n";
	                                            cout<<"\t 3.Dr Raj Khetan \n";
	                                            cout<<"\n Please enter your choice:";
	                                            cin>>neo_ch;
	                                            switch (neo_ch)
	                                            {
...
int main()
{
	hospital a1;
    char ans='y',ans2;
    cout<<"\t \t WELCOME TO TIMENEAR HOSPITAL \n";
    do
    {   
    	if(chk!='y')
    		return 0;
